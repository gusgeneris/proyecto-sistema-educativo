...
if(isset($_GET['mj'])){
    ...
    if ($error==ERROR_LOGIN_CODE){
        ...
        <div id="mensaje" class="mensajeError"><?php echo $mensaje;?></div><?php
    }
        ...
        <div id="mensaje" class="mensajeAlert"><?php echo $mensaje;?></div><?php
    ...
    }else if ($error==INCORRECT_INSERT_DATO_DUPLICATE_CODE){
        $mensaje=INCORRECT_INSERT_DATO_DUPLICATE_MENSAJE;?>
        <div id="mensaje" class="mensajeError"><?php echo $mensaje;?></div><?php
        
    }else if ($error==INCORRECT_INSERT_DATO_DUPLICATE_USER_NAME_CODE){
        $mensaje=INCORRECT_INSERT_DATO_DUPLICATE_USER_NAME_MENSAJE;?>
        <div id="mensaje" class="mensajeError"><?php echo $mensaje;?></div><?php
        
    }else if ($error==CORRECT_SEARCH_CODE){
        $mensaje=CORRECT_SEARCH_MENSAJE;?>
        <div id="mensaje" class="mensaje"><?php echo $mensaje;?></div><?php
        
    }else if ($error==INCORRECT_INSERT_DATO_DUPLICATE_NUMBER_EJE_CODE){
        $mensaje=INCORRECT_INSERT_DATO_DUPLICATE_NUMBER_EJE_MENSAJE;?>
        <div id="mensaje" class="mensajeError"><?php echo $mensaje;?></div><?php
