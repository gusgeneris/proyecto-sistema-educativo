                        ...
                        <tr >
                            ...
                            <td>
                                ...
                                <?php    
                                    ...
                                    if ($estado==2){?>
                                    <a href="dar_alta.php?id=<?php echo $usuario->getIdPersona()?>"><img class="icon-a" src="../../icon/alta.png" title="Dar Alta" alt="Dar Alta"></a>
                                <?php }else{ ?>
                                <a href="#" onclick="consulta(<?php echo $usuario->getIdPersona()?>)"><img class="icon-a" src="../../icon/basurero.png" title="Eliminar" alt="Eliminar"></a>
