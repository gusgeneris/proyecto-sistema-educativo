...
<h1 class="titulo"> Registro de Ciclo Lectivo</h1>
    ...
    <form action="procesar_insert.php" method=POST class="formInsertUnaColumna" id="formInsert" name="formInsert">
        ...
        <div class="formGrup" id="GrupoAnioDesarrollo">
        
        <label for="DetalleAnio" class="formLabel">Ciclo Lectivo</label>    
            <div class="formGrupInput">
                <input autofocus type="text"  id="DetalleAnio" name="DetalleAnio" class="formInput" placeholder="Año" >
