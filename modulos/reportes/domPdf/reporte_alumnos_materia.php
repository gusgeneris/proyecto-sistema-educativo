...
$listadoAlumnos=Alumno::listadoPorIdCurriculaCarrera($idCicloLectivoCarrera,$idMateria);
...
<html lang="es">
    ...
    <body>
        ...
        <div class="subtitulo">
            <h2>Carrera: <span> <?php echo $carrera->getNombre()?></h2>
            <h2>Materia:  <span> <?php echo $materia->getNombre()?></span></h2>
